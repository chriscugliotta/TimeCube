    ...
    private void moveHorizontally( ref Vector3 deltaMovement )
    {
        ...
        for( var i = 0; i < totalHorizontalRays; i++ )
        {
            ...
            if( _raycastHit )
            {
                ...
                // Customization:  Always check all rays
                // if( rayDistance < _skinWidth + kSkinWidthFloatFudgeFactor ) { break; }
            }
        }
    }
    ...
    private void moveVertically( ref Vector3 deltaMovement )
    {
        ...
        for( var i = 0; i < totalVerticalRays; i++ )
        {
            ...
            if( _raycastHit )
            {
                ...
                // Customization:  Always check all rays
                // if( rayDistance < _skinWidth + kSkinWidthFloatFudgeFactor ) { return; }
            }
        }
    }
